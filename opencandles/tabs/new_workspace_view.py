...
from opencandles.ui.workspace_icons import workspace_icon
...
class NewWorkspaceView(QtWidgets.QWidget):
    ...
    def __init__(self, registry: PageRegistry, parent=None):
        ...
        self.page_buttons = {}
        for index, (page_type, label) in enumerate(registry.menu_entries()):
            button = QtWidgets.QPushButton(label)
            button.setObjectName("workspaceCard")
            button.setIcon(workspace_icon(page_type))
            ...
            self.page_buttons[page_type] = button
