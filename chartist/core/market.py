...
from chartist.config import HISTORY_SEC, START_PRICE, VOLS
...
def generateHistory(n_sec, start, k=3):
...
class Market:
    ...
    def __init__(self):
        ...
        n = now - self.t0
        o, h, l, c, v = generateHistory(n, START_PRICE)
        cap = n + 100_000
...
__all__ = ["Market", "MarketSim", "generateHistory"]
