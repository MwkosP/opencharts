...
_SVG = {
    ...
    """,
    "onchain": """
        <circle cx="17" cy="17" r="12" fill="none" stroke="#2962ff" stroke-width="2"/>
        <circle cx="10" cy="12" r="2.2" fill="#26a69a"/>
        <circle cx="24" cy="11" r="2.2" fill="#c9d1d9"/>
        <circle cx="13" cy="23" r="2.2" fill="#f0b429"/>
        <circle cx="23" cy="22" r="2.2" fill="#b99cff"/>
        <path d="M10 12l14-1M10 12l3 11M24 11l-1 11M13 23l10-1"
          fill="none" stroke="#8b949e" stroke-width="1.3"/>
    """,
    "news": """
...
def workspaceIcon(page_type: str, size=36) -> QtGui.QIcon:
